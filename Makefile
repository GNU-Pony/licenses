...
MISC = AAL ACDL AFL{1.1,1.2,2.0,2.1,3.0} AGPL{1,2,3} Apache{1.0,1.1,2.0} \
       APSL{1.0,1.1,1.2,2.0} Arphic Artistic{1.0,2.0} BSD BSDL CATOSL1.1 \
       CC0 CDDL CPAL CPL CPOL1.02 Cryptix CUA-OPL DSL ECL{1.0,2.0} Ecos2.0 \
       EFL{1,2}  Entessa EPL EUDataGrid Expat Fair FDL{1.1,1.2,1.3} \
       Frameworx FreeBSDDL Freetype GNUAllPermissive GNUVerbatim GPL{1,2,3} \
       HESSLA HPND ICS imlib2 IntelACPI IOSL IPA IPL JOSL LGPL{2.0,2.1,3} \
       LPL1.02 LPPL1.{0,1,2,3{,a,b,c}} MIT Motosoto MPL{1.0,1.1,2.0} Ms-PL \
       Ms-RL Multics NASA1.3 Naumen nBSD NGPL Nokia none NOSL NPL{1.0,1.1} \
       NPOSL3.0 NSCA NTP OCL OCLC1.2 ODbl OFL1.1 OFPL OGTSL OpenPub \
       OSL{1.0,2.0,2.1,3.0} pBSD PerlArtistic PHP{2.01,2.02,3.0,3.01} \
       PostgreSQL public{,-bin} QPL RPL{1.1,1.3,1.5} RPSL RSCPL Ruby sBSD \
       SFL SimPL-2.0 SISSL{1.0,1.1,1.2} Sleepycat SPL VSL W3C Watcom \
       WTFPL{1,2} WXwindows Xnet XOSL YPL{1.0,1.1} zlib ZPL{1.0,2.0,2.1}
